/**
 * Icônes SVG custom pour Les Récoltants
...
export function RestaurantIcon({ className = "", size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
      ...
      className={className}
    >
      <path d="M3 2v7c0 1.1.9 2 2 2h4a2 2 0 002-2V2M7 2v20M21 15V2v0a5 5 0 00-5 5v6c0 1.1.9 2 2 2h3zM16 22v-6" />
    </svg>
  );
}

export function BasketIcon({ className = "", size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
      ...
      className={className}
    >
      <path d="M6.5 8h11l-2 9H8.5l-2-9z" />
      <path d="M9 11V6a3 3 0 116 0v5M6.5 8h-3l2-6h13l2 6h-3" />
    </svg>
  );
}

export function JarIcon({ className = "", size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <path d="M8 5v16a2 2 0 002 2h4a2 2 0 002-2V5" />
...
export function ChefHatIcon({ className = "", size = 24 }: IconProps) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M6 13.87A4 4 0 017.43 6a5.5 5.5 0 0110.14 0A4 4 0 0119 13.87V21H6z" />
      <path d="M6 21h12M9 21V17M15 21V17" />
    </svg>
  );
}
...
export function SparklesIcon({ className = "", size = 24 }: IconProps) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M12 3l1.912 5.813 6.088.612-4.5 4.087 1.5 6.088L12 16.5l-5 3.1 1.5-6.088-4.5-4.087 6.088-.612L12 3z" />
      <path d="M6 3l.5 1.5L8 5l-1.5.5L6 7l-.5-1.5L4 5l1.5-.5L6 3zM19 7l.5 1.5L21 9l-1.5.5L19 11l-.5-1.5L17 9l1.5-.5L19 7z" />
    </svg>
  );
}

export function RecycleIcon({ className = "", size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
      ...
      className={className}
    >
      <path d="M3 6h3l2-2h8l2 2h3M3 6l2 12h10l2-12M8 10l-2 2 2 2M16 10l2 2-2 2M12 4v16" />
    </svg>
  );
}
...
export function HandshakeIcon({ className = "", size = 24 }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M7 21h1c.5 0 1-.2 1.4-.6l5.6-5.6a2 2 0 0 1 2.8 0l4.6 4.6a2 2 0 0 0 2.8 0l2.6-2.6a2 2 0 0 0 0-2.8l-5.6-5.6a2 2 0 0 1 0-2.8l1.6-1.6a2 2 0 0 0 0-2.8L18 4" />
      <path d="M2 12h4" />
    </svg>
  );
}

export function AutumnLeafIcon({ className = "", size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
